...
cgosret_ulong CgosStorageAreaBlockSize(HCGOS hCgos, unsigned int dwUnit)
  { return CallDrvPlain(1,xCgosStorageAreaBlockSize,hCgos,dwUnit,0,0,0,0,NULL,NULL); }
...
CGOSDLLAPI unsigned char *CGOSAPI CgosCgebTransAddr(HCGOS hCgos, unsigned char *pBytes)
  { return (unsigned char *)(uintptr_t)CallDrvPlain(1,xCgosCgebTransAddr,hCgos,0,(uintptr_t)pBytes,0,0,0,NULL,NULL); }
